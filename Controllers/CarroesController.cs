...
namespace ProjetoGaragemIdentity.Controllers
{
    ...
    public class CarroesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Modelo,Marca,Ano,Descricao")] Carro carro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Modelo,Marca,Ano,Descricao")] Carro carro)
        {
            if (id != carro.Id)
            {
                return NotFound();
