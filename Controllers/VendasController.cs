...
namespace ProjetoGaragemIdentity.Controllers
{
    ...
    public class VendasController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return View(await _context.Venda.Include(c => c.Funcionario).ToListAsync());
        ...
        public async Task<IActionResult> Create([Bind("Valor,Id,Descricao")] Venda venda)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Valor,Id,Descricao")] Venda venda)
        {
            if (id != venda.Id)
            {
                return NotFound();
